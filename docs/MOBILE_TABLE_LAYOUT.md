...
1. npm checks/build and PR CI on the refreshed head;
2. deploy-preview browser layout measurements at the documented mobile viewports;
3. owner iPhone VoiceOver acceptance, especially focus timing, cards-first swipe order, Current state touch discovery and absence of duplicate speech;
4. sighted verification of Start game, called suit, dealer/active state, loner/sitting-out comprehension and ordinary Val-card rendering.
